...
def get_contract(contract_name):
    ...
    if defined, otherwise, it will deploy a mock version of that contract, and return that mock contract.
        ...
        Returns:
            brownie.network.contract.ProjectContract: The most refently deployed version of this contract.
    """
...
DECIMALS = 8
INITITAL_VALUE = 200000000000


def deploy_mocks(decimals=DECIMALS, initial_value=INITITAL_VALUE):
    account = get_account()
